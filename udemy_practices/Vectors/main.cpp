...
int main(){
	...
	//vector <char> vowels (5); //size 5, all initialized to zero
	vector <char> vowels {'a', 'e', 'i', 'o', 'u'}; 
	
	cout << vowels[0] << endl; 
	cout << vowels[1] << endl;
	
	//vector <int> test_scores (3); //3 initalized to zero
	//vector <int> test_scores (3,100); //3 initalized to 100
	...
	cout << "\nEntered test scores: " << endl;  
	cout << test_scores.at(0) << endl; 
	cout << test_scores.at(1) << endl; 
	cout << test_scores.at(2) << endl; 
	
	cout << "Enter a test score to add in vector : " << endl; 
	...
	cout << "Enter one more test score to add in vector : " << endl; 
	cin >> score_to_add; 
	test_scores.push_back(score_to_add); 
